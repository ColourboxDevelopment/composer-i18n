...
final class Test extends TestCase {
    ...
    public function testCanInstantiateApiObject(): void {
        global $cache, $api;
        $api = new CBX\API(APIURL, $cache);
        $this->assertInstanceOf(
            CBX\API::class,
            $api
        );
    ...
    public function testCanCreateObjectWithFactory(): void {
        ...
        $i18nFromFactory = CBX\I18nFactory::createMemcached(LANGUAGE, DOMAIN, APIURL, MEMCACHED_HOST, MEMCACHED_PORT);
        $this->assertEquals(
            APIURL,
